...
function draw() {
  ...
  // var main_angle = get_angle(0);
  // if(main_angles.length<50){
  //   main_angles.push(main_angle);
  // }else{
  //   main_angles = track_motion(main_angle);
  // }
...
function getAngle(part) {
      ...
      return angle(lw.position, ls.position, lh.position)
